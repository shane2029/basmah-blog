...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    emailjs.init('JOSYWMNv1PgCtWCzu');
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    const serviceId = 'service_z4jqpk4';
    const templateId = 'template_199azjf';
        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">hello@blossomblog.com</p>
              </div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/me?trk=p_mwlite_feed-secondary_nav" className="text-gray-600 hover:text-secondary transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
